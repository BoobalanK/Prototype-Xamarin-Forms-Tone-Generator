...
namespace ServicesDemo3
{
	...
	public class TimestampService : Service
	{
		...
		{
			NotificationChannel chan = new NotificationChannel(Constants.NOTIFICATION_CHANNEL_ID, "Background Notification", NotificationImportance.None)
			{
			...
			var notification = new Notification.Builder(this, Constants.NOTIFICATION_CHANNEL_ID)
				.SetContentTitle("Foreground Service Demo")
				.SetContentText("The started service is running.")
				//.SetSmallIcon(Android.Resource.Drawable.ic_stat_name)
		...
		Notification.Action BuildRestartTimerAction()
		{
			...
			var builder = new Notification.Action.Builder(0,
											  "Restart Timer",
